...
public class ConstKeys {
    ...
    public static final String FIND_PATH_MENU_ITEM = "FIND_PATH_MENU_ITEM";
    ...
    public static final String RESET_GRAPH_MENU_ITEM = "RESET_GRAPH_MENU_ITEM";
    public static final String EDIT_GRAPH_MENU_ITEM = "EDIT_GRAPH_MENU_ITEM";
